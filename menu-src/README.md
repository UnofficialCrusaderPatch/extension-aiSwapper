...
Group controls cover all editable AI component selections in scope, including inherited selections, using the existing sparse override model. Mixed or Suggested becomes Required for the entire selection; Required becomes Suggested. Current AI values are preserved. Upstream requirements, menu bookkeeping and default language remain excluded. A component with no AI selection has no resource value to require. This remains independent from the enabled/inherit/deactivated sword cycle.
